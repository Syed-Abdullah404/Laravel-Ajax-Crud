          ...
          <form action="" method="POST" id="add_product_form" enctype="multipart/form-data">
            ...
            <div class="modal-body p-4 bg-light">
              ...
              <div class="my-2">
                ...
                <input type="date" name="date" class="form-control" placeholder="E-mail">
              </div>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary close" data-bs-dismiss="modal">Close</button>
              <button type="submit" id="add_product_btn" class="btn btn-primary" name="submit">Add Product</button>
            </div>
          </form>
      ...
      <div class="main-panel">
        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <i class="bi-pencil-square h2" data-bs-toggle="modal" data-bs-target="#exampleModal" style="margin-left: 90%;size:50px"></i>
